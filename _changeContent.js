...
TH:
การบินไทยให้บริการเก้าอี้รถเข็น โดยไม่คิดค่าใช้จ่าย กรุณาแจ้งก่อน 48 ชั่วโมง
	*/
}
var dialog_baggage = {
...
function setTimeoutBAG() {
	...
	// 	window.setTimeout(function () {
	// 	updateHTML.extraService('div.catalogServices-teaser-SIT','div.catalogServices-teasers-container','seat');
	// 	}, 600)        
	// 	})
